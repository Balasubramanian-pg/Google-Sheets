...
- [Readme.md](..\4. Advanced Features\Readme.md) <!-- score: 2.285 | shared: advanced, automate, cell, cells, columns -->
- [Readme.md](..\3. Data Management\Readme.md) <!-- score: 2.187 | shared: advanced, based, basic, cells, column -->
- [Readme.md](..\1. Basics\Readme.md) <!-- score: 2.147 | shared: average, based, basic, cell, cells -->
- [README.md](..\README.md) <!-- score: 1.960 | shared: advanced, automate, basic, cell, date -->
- [Readme.md](..\6. Automation and Scripts\Readme.md) <!-- score: 1.850 | shared: advanced, automate, contents, error, functions -->
